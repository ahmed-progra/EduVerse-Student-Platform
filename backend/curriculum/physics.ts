...
export const physics: LessonDef[] = [
  L("Newton's Laws of Motion", ["mechanics", "forces", "motion"], "beginner", 12, {
    ...
    examples: [
      ...
      ex(
        "Finding acceleration from force",
    ...
    quiz: [
      ...
      q(
        ...
        ["Action-reaction", "Inertia", "Acceleration", "Gravity"],
        1,
        `The law of inertia: objects resist changes in motion.`,
      ),
    ],
  }),
  ...
  L("Velocity and Acceleration", ["mechanics", "motion", "kinematics"], "beginner", 12, {
    ...
    examples: [
      ex(
        "Using v = u + at",
        `u = 0  # m/s (starting from rest)\na = 9.8  # m/s² (gravity)\nt = 3  # seconds\nv = u + a * t\nprint(f"After {t}s, velocity = {v:.1f} m/s")`,
        `After 3s, velocity = 29.4 m/s`,
      ),
      ex(
        "Using v² = u² + 2as",
        `u = 15  # m/s\na = -2  # m/s² (braking)\ns = 50  # meters\nv = (u**2 + 2*a*s) ** 0.5\nprint(f"Final velocity: {v:.1f} m/s")\nprint(f"After braking {s}m from {u} m/s")`,
    ...
    quiz: [
      q(
        "If a car accelerates from 0 to 20 m/s in 4 seconds, what's its acceleration?",
        ["4 m/s²", "5 m/s²", "20 m/s²", "0.2 m/s²"],
        1,
        `a = (20 − 0) / 4 = 5 m/s².`,
      ),
      q(
        "What does the equation v = u + at tell you?",
        ["Distance traveled", "Final velocity after time t", "Average speed", "Acceleration"],
        1,
        `It gives final velocity from initial velocity, acceleration, and time.`,
      ),
      q(
        "A ball thrown up at 10 m/s with g = −9.8 m/s². When does it stop (v = 0)?",
        ["About 1 second", "About 2 seconds", "About 0.5 seconds", "About 10 seconds"],
        0,
        `0 = 10 + (−9.8)t → t = 10/9.8 ≈ 1.02 s.`,
      ),
    ],
  }),
  ...
  L("Projectile Motion", ["mechanics", "motion", "projectiles"], "intermediate", 14, {
    ...
    quiz: [
      q(
        "What angle gives the maximum range for projectile motion?",
        ["30°", "45°", "60°", "90°"],
        1,
        `45° maximizes sin(2θ) = sin(90°) = 1.`,
      ),
      q(
        "Horizontal motion of a projectile has...",
        ["Constant acceleration", "Constant velocity", "Increasing speed", "No motion"],
        1,
        `No horizontal force means constant horizontal velocity.`,
      ),
      q(
        "Two projectiles at 30° and 60° with the same speed have...",
        [
          "Same height, different range",
          "Different height, same range",
          "Same height and range",
          "Different height and range",
        ],
        1,
        `Complementary angles give the same range but different max heights.`,
      ),
    ],
  }),
  ...
  L("Work, Energy, and Power", ["mechanics", "energy", "work"], "intermediate", 14, {
    ...
    quiz: [
      q(
        ...
        ["Watts", "Joules", "Newtons", "Pascals"],
        1,
        `Work and energy are measured in joules (J).`,
      ),
      q(
        "A 5 kg object at 10 m height has how much PE? (g = 10)",
        ["50 J", "500 J", "250 J", "100 J"],
        1,
        `PE = 5 × 10 × 10 = 500 J.`,
      ),
      q(
        "Doubling speed multiplies KE by...",
        ["2", "4", "1.5", "8"],
        1,
        `KE = ½mv², so doubling v quadruples KE.`,
      ),
    ],
  }),
  ...
  L("Wave Properties", ["waves", "optics", "oscillations"], "beginner", 10, {
    ...
    quiz: [
      ...
      q(
        "If frequency doubles, wavelength... (speed constant)",
        ["Doubles", "Halves", "Quadruples", "Stays same"],
        1,
        `Since v = f × λ, doubling f halves λ.`,
      ),
      q(
        "What unit is frequency measured in?",
        ["Meters", "Seconds", "Hertz", "Joules"],
        2,
        `Hertz (Hz) = 1/s.`,
      ),
    ],
  ...
  L("Sound Waves", ["waves", "sound", "acoustics"], "beginner", 10, {
    ...
    quiz: [
      q(
        ...
        2,
        `Sound moves fastest in solids (steel: ~5000 m/s), slowest in gases.`,
      ),
      q(
        "A high-pitched sound has...",
        ["High frequency", "High amplitude", "Long wavelength", "Low frequency"],
        0,
        `Pitch = frequency. High frequency = high pitch.`,
      ),
      q(
        "The Doppler effect explains why an ambulance siren changes pitch because...",
        [
          "The air changes temperature",
          "The source moves relative to you",
          "Sound speeds up",
          "The siren changes frequency",
        ],
        1,
        `Motion of source/observer changes the perceived frequency.`,
      ),
    ],
  }),
  ...
  L("Light and Reflection", ["optics", "light", "reflection"], "intermediate", 12, {
    ...
    quiz: [
      q(
        ...
        ["3 × 10⁶ m/s", "3 × 10⁸ m/s", "3 × 10¹⁰ m/s", "343 m/s"],
        1,
        `c = 3.0 × 10⁸ m/s ≈ 300,000 km/s.`,
      ),
      q(
        "If θᵢ = 40°, what is θᵣ?",
        ["50°", "40°", "80°", "20°"],
      ...
      q(
        ...
        ["Real and inverted", "Virtual and upright", "Virtual and inverted", "Real and upright"],
        1,
  ...
  L("Refraction and Lenses", ["optics", "refraction", "lenses"], "intermediate", 12, {
    ...
    quiz: [
      q(
        "When light enters water from air, it bends...",
        ["Away from the normal", "Toward the normal", "It doesn't bend", "In a straight line"],
        1,
        `Water has a higher refractive index than air, so light bends toward the normal.`,
      ),
      q(
        "Snell's law is: n₁·sin(θ₁) = n₂·sin(θ₂). What does n represent?",
        ["Angle", "Speed", "Refractive index", "Wavelength"],
        2,
        `n is the refractive index of the medium.`,
      ),
      q(
        "A convex lens is also called...",
        ["Diverging", "Converging", "Reflecting", "Diffracting"],
        1,
  ...
  L("Electric Charge and Fields", ["electricity", "fields", "charge"], "intermediate", 14, {
    ...
    quiz: [
      q(
        ...
        ["Doubles", "Halves", "Quarter", "Quadruples"],
        2,
        `Inverse square law: doubling r makes F = 1/4.`,
      ),
      q(
        ...
        2,
        `Neutral means equal amounts of positive and negative charge.`,
      ),
      q(
  ...
  L(
    "Circuits and Resistance (Ohm's Law)",
    ...
    14,
    {
      ...
      quiz: [
        q(
          ...
          ["Doubles", "Halves", "Quadruples", "Stays same"],
          0,
          `I = V/R: double V doubles I.`,
        ),
        q(
          "Two 10Ω resistors in series give...",
          ["5Ω", "10Ω", "20Ω", "100Ω"],
          2,
          `Series: Rₜ = R₁ + R₂ = 10 + 10 = 20Ω.`,
        ),
        q(
  ...
  L("Magnetic Fields", ["magnetism", "fields", "electromagnetism"], "advanced", 14, {
    ...
    quiz: [
      q(
        ...
        ["Stationary charges", "Moving charges", "Only magnets", "Only metals"],
        1,
        `Moving charges (electric current) produce magnetic fields.`,
      ),
      q(
        "The unit of magnetic field is the...",
        ["Tesla", "Weber", "Gauss", "Ampere"],
        0,
        `Magnetic field strength is measured in teslas (T).`,
      ),
      q(
        "The force on a wire is maximum when the current is...",
        ["Parallel to B", "Perpendicular to B", "At 45° to B", "Opposite to B"],
        1,
        `sin(90°) = 1 gives maximum force.`,
      ),
    ],
  }),
  ...
  L("Electromagnetic Induction", ["electromagnetism", "induction", "faraday"], "advanced", 14, {
    ...
    quiz: [
      ...
      q(
        ...
        [
          "More primary than secondary turns",
          "More secondary than primary turns",
          "Equal turns",
          "No core",
        ],
        1,
        `More secondary turns = higher secondary voltage.`,
      ),
      q(
        "Lenz's law says the induced current...",
        ["Reinforces the change", "Opposes the change", "Is constant", "Doesn't exist"],
        1,
        `The negative sign in Faraday's law: induced current opposes the flux change.`,
      ),
    ],
  }),
...
<!-- 3D MODEL PLACEHOLDER -->`,
    ...
    quiz: [
      q(
        ...
        ["Number of neutrons", "Number of protons", "Number of electrons", "Total mass"],
        1,
        `Atomic number (protons) defines which element it is.`,
      ),
      q(
        "Most of an atom's mass is in the...",
        ["Electron cloud", "Nucleus", "Orbitals", "Covalent bonds"],
        1,
        `Protons and neutrons (in the nucleus) account for ~99.9% of atomic mass.`,
      ),
      q(
        "Carbon-12 has 6 protons and 6 neutrons. Carbon-14 has...",
        ["6p, 8n", "8p, 6n", "14p, 0n", "6p, 14n"],
        0,
        `14 − 6 = 8 neutrons. Same 6 protons (still carbon), more neutrons.`,
      ),
    ],
  }),
  ...
  L("Radioactivity", ["modern-physics", "radioactivity", "nuclear"], "intermediate", 12, {
    ...
    examples: [
      ex(
        ...
        `N0 = 100  # initial atoms\nt_half = 8  # days\nfor t in [0, 8, 16, 24, 32]:\n    N = N0 * 0.5 ** (t / t_half)\n    print(f"Day {t:2d}: {N:.1f} atoms remaining")`,
        `Day  0: 100.0 atoms remaining\nDay  8: 50.0 atoms remaining\nDay 16: 25.0 atoms remaining\nDay 24: 12.5 atoms remaining\nDay 32: 6.3 atoms remaining`,
      ),
      ex(
        "How many half-lives to reach 1%?",
        `import math\nN_ratio = 0.01\nhalf_lives = math.log(N_ratio) / math.log(0.5)\nprint(f"To reach 1% remaining: {half_lives:.2f} half-lives")`,
        `To reach 1% remaining: 6.64 half-lives`,
      ),
    ],
    ...
    quiz: [
      ...
      q(
        ...
        ["1", "2", "4", "0"],
        2,
        `Alpha decay emits 2p+2n → mass number −4.`,
      ),
    ],
  }),
  ...
  L("Quantum Basics", ["modern-physics", "quantum", "mechanics"], "advanced", 16, {
    ...
    quiz: [
      q(
        ...
        ["Nuclear binding", "Photon energy", "Atomic mass", "Gravity"],
        1,
        `Planck-Einstein: photon energy = Planck's constant × frequency.`,
      ),
      q(
        "Which is NOT a quantum phenomenon?",
        [
        ...
        1,
        `Planetary motion is classical; the others require quantum mechanics.`,
      ),
      q(
        ...
        [
          ...
          "Electrons are only particles",
        ],
        1,
        `Both light and matter exhibit wave and particle behaviors depending on the experiment.`,
      ),
    ],
  }),
  ...
  L("Relativity Introduction", ["modern-physics", "relativity", "einstein"], "advanced", 14, {
    ...
    quiz: [
      q(
        "In special relativity, which is constant for all observers?",
        ["Time", "Speed of light", "Mass", "Energy"],
        1,
        `The speed of light in a vacuum (c) is the same for all inertial observers.`,
      ),
      q(
        "E = mc² shows that...",
        [
        ...
        0,
        `Mass and energy are interchangeable. Small mass = huge energy.`,
      ),
      q(
        "Time dilation means a moving clock...",
        ["Runs faster", "Runs slower", "Stops", "Runs at same rate"],
        1,
        `Moving clocks tick slower relative to stationary observers.`,
      ),
    ],
  }),
];
