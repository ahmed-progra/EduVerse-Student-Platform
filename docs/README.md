...
Welcome to the EduVerse documentation. This directory contains everything you
need to understand the project's architecture, API surface, data model, design
