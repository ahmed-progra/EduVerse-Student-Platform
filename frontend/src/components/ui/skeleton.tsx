...
export function SkeletonRow() {
  return (
    <div className="flex items-center justify-between py-3.5 px-4 border border-white/5 bg-white/[0.01]" style={{ borderRadius: "var(--radius-card)" }}>
      <div className="flex items-center gap-3 w-2/3">
        <div className="w-8 h-8 rounded-full shrink-0" style={{ background: "var(--color-eduverse-surface)", animation: "sk-shimmer 1.8s infinite linear" }} />
        <div className="sk-text w-full">
  ...
  return (
    <div className="flex items-center justify-between py-3 px-3 border border-transparent">
      <div className="flex items-center gap-3 w-1/2">
        <div className="w-5 h-5 rounded shrink-0" style={{ background: "var(--color-eduverse-surface)", animation: "sk-shimmer 1.8s infinite linear" }} />
  ...
  return (
    <div className="flex items-end justify-center gap-6 my-8">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="w-20 h-20 rounded-t-xl" style={{ background: "var(--color-eduverse-surface)", animation: "sk-shimmer 1.8s infinite linear" }} />
      </div>
    </div>
  );
}
