    ...
    <div className="w-full">
      {showLabel && (
        <div className="flex justify-between items-center mb-2">
          <div className="flex items-center gap-1 text-xs font-mono text-eduverse-accent">
            <Star className="w-3 h-3" aria-hidden="true" />
            Level {level}
          </div>
          <div className="flex items-center gap-1 text-xs text-eduverse-text-muted font-mono">
            <Zap className="w-3 h-3 text-eduverse-accent" aria-hidden="true" />
            <span className="text-eduverse-text-body">{current.toLocaleString()}</span>
