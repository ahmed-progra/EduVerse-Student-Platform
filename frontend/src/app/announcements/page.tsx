      ...
      {posting && (
        <div className="glass-panel res-form">
          <div className="res-form-grid" style={{ gridTemplateColumns: "1fr 160px" }}>
            <input
              className="app-input"
              placeholder="Title (e.g. Midterm moved to Friday)"
              value={form.title}
            ...
            <div key={a.id} className={`ann-card glass-panel ${a.pinned ? "pinned" : ""}`}>
              ...
              <div className="ann-body">
                <div className="ann-head">
                  ...
                  {a.pinned && (
                    <span className="ann-tag" style={{ color: "var(--color-eduverse-warning)" }}>
                      Pinned
                    </span>
                  )}
                </div>
                ...
                <div className="ann-meta">
                  <span className="inline-flex items-center gap-1">
                    <Clock size={12} aria-hidden="true" /> {timeAgo(a.createdAt)}
                  </span>
                  <button className="ann-action" onClick={() => togglePin(a.id)}>
                    {a.pinned ? (
                      ...
                      <>
                        <Pin size={13} aria-hidden="true" /> Pin
                      </>
                    )}
                  </button>
