                ...
                <motion.div {...cardHover}>
                  <GlassCard className="h-full">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0 text-xl" style={{ background: "var(--color-eduverse-accent-soft)" }} aria-hidden="true">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-eduverse-text-muted mb-4 leading-relaxed line-clamp-2">{course.description}</p>
